...
price = [1 sqft_norm br_norm] * theta;
price1 = [1 sqft_norm br_norm] * theta1;
price2 = [1 sqft_norm br_norm] * theta2;
price3 = [1 sqft_norm br_norm] * theta3;
price4 = [1 sqft_norm br_norm] * theta4;
...
fprintf(['Predicted price1, price2, price3, price4 of a 1650 sq-ft, 3 br house ' ...
